...
@interface SWHomeCollectionViewLayout ()
...
@implementation SWHomeCollectionViewLayout
...
- (id<SWHomeCollectionViewLayoutDelegate>)_delegate
{
  return (id<SWHomeCollectionViewLayoutDelegate>)self.collectionView.delegate;
}

@end

@implementation SWHomeCollectionViewLayoutInspector

- (ASSizeRange)collectionView:(ASCollectionView *)collectionView constrainedSizeForNodeAtIndexPath:(NSIndexPath *)indexPath
{
  SWHomeCollectionViewLayout *layout = (SWHomeCollectionViewLayout *)[collectionView collectionViewLayout];
